    ...
    <FooterStyles>
      <div className="container">
        ...
        <ParagraphText className="footer__text">
          "Thank you for choosing Energy Bros Internet Cafe. Your digital
          ...
          seamless blend of technology and hospitality. Energy Bros Internet
        ...
        <ParagraphText className="copyright">
          © Energy Bros Group Internet Cafe (PTY) LTD |{' '}
